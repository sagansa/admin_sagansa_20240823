...
return [
    'dailySalaries' => [
        'itemTitle' => 'Gaji Harian',
        'collectionTitle' => 'Gaji Harian',
        'inputs' => [
            'store_id' => [
                'label' => 'Cabang',
                'placeholder' => 'Cabang',
    ...
    'paymentReceipts' => [
        'itemTitle' => 'Bukti Pembayaran',
        'collectionTitle' => 'Bukti Pembayaran',
        'inputs' => [
            'image' => [
                'label' => 'Image',
                'placeholder' => 'Image',
            ...
            'payment_for' => [
                ...
                'placeholder' => 'Pembayaran Untuk',
            ],
            'image_adjust' => [
                'label' => 'Image adjust',
                'placeholder' => 'Image adjust',
            ],
            'notes' => [
                'label' => 'Notes',
                'placeholder' => 'Notes',
    ...
    'fuelServicePaymentReceipt' => [
        'itemTitle' => 'Fuel Service Payment Receipt',
        'collectionTitle' => 'Fuel Service Payment Receipt',
    ],
    'dailySalaryPaymentReceipt' => [
        'itemTitle' => 'Daily Salary Payment Receipt',
        'collectionTitle' => 'Daily Salary Payment Receipt',
    ],
    'invoicePurchasePaymentReceipt' => [
        'itemTitle' => 'Invoice Purchase Payment Receipt',
        'collectionTitle' => 'Invoice Purchase Payment Receipt',
    ],
    'remainingStocks' => [
        'itemTitle' => 'Remaining Stock',
        'collectionTitle' => 'Remaining Stocks',
        'inputs' => [
            'date' => [
                'label' => 'Date',
                'placeholder' => 'Date',
    ...
    'productRemainingStock' => [
        'itemTitle' => 'Product Remaining Stock',
        'collectionTitle' => 'Product Remaining Stock',
        'inputs' => [
            'quantity' => [
                'label' => 'Quantity',
    ...
    'deliveryAddresses' => [
        ...
        'collectionTitle' => 'Delivery Addresses',
        'inputs' => [
            'name' => [
                'label' => 'Name',
                'placeholder' => 'Name',
            ...
            'recipients_telp_no' => [
                ...
                'placeholder' => 'Recipients telp no',
            ],
            'address' => [
                'label' => 'Address',
                'placeholder' => 'Address',
    ...
    'fuelServices' => [
        'itemTitle' => 'Fuel Service',
        'collectionTitle' => 'Fuel Services',
        'inputs' => [
            'fuel_service' => [
                'label' => 'Fuel service',
    ...
    'requestPurchases' => [
        'itemTitle' => 'Request Purchase',
        'collectionTitle' => 'Request Purchases',
        'inputs' => [
            'store_id' => [
                'label' => 'Store',
                'placeholder' => 'Store',
    ...
    'detailRequests' => [
        'itemTitle' => 'Detail Request',
        'collectionTitle' => 'Detail Requests',
        'inputs' => [
            'product_id' => [
                'label' => 'Product',
                'placeholder' => 'Product',
    ...
    'invoicePurchases' => [
        'itemTitle' => 'Invoice Purchase',
        'collectionTitle' => 'Invoice Purchases',
        'inputs' => [
            'image' => [
                'label' => 'Image',
                'placeholder' => 'Image',
    ...
    'cashAdvances' => [
        'itemTitle' => 'Cash Advance',
        'collectionTitle' => 'Cash Advances',
        'inputs' => [
            'image' => [
                'label' => 'Image',
                'placeholder' => 'Image',
    ...
    'advancePurchases' => [
        'itemTitle' => 'Advance Purchase',
        'collectionTitle' => 'Advance Purchases',
        'inputs' => [
            'image' => [
                'label' => 'Image',
                'placeholder' => 'Image',
    ...
    'permitEmployees' => [
        'itemTitle' => 'Permit Employee',
        'collectionTitle' => 'Permit Employees',
        'inputs' => [
            'reason' => [
                'label' => 'Reason',
                'placeholder' => 'Reason',
    ...
    'movementAssetAudits' => [
        ...
        'inputs' => [
            ...
            'movement_asset_result_id' => [
                ...
                'placeholder' => 'Movement asset result',
            ],
        ],
        'filament' => [
            'image' => [
    ...
    'vehicleCertificates' => [
        ...
        'inputs' => [
            ...
            'vehicle_identity_no' => [
                'label' => 'Vehicleentity no',
                'placeholder' => 'Vehicleentity no',
            ],
            'engine_no' => [
                'label' => 'Engine no',
