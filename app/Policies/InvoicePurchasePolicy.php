...
class InvoicePurchasePolicy
{
    ...
    {
        return $user->can('view_panel::invoice::purchase') && $invoicePurchase->order_status === 2;
    }
    ...
    {
        return $user->can('update_panel::invoice::purchase') && $invoicePurchase->order_status !== 2;
    }
